...
模式 & 说明 & 备注 \\
\hline
/1/w/\textless Width\textgreater /h/\textless Height\textgreater & 以指定宽度和高度中的较大者为基准等比缩放，裁剪新图正中\textless width\textgreater x\textless height\textgreater 大小的部分 \newline 可以仅指定宽度或高度 &  \qsample{imageView-1-250x200} \newline \qsample{imageView-1-200x200} \newline  \qsample{imageView-1-200x300} \newline \qsample{imageView-1-200x500} \\
\hline
/2/w/\textless Width\textgreater /h/\textless Height\textgreater & 同时指定宽度和高度，原图缩小为不超出\textless width\textgreater x\textless height\textgreater 大小的缩略图，避免裁剪长边 \newline 可以仅指定宽度或高度 & \qsample{imageView-2-200x200} \newline \qsample{imageView-2-x200} \\
\hline
\end{tabular}
}

\begin{center}
\includegraphics[scale=1.1]{../pics/pic_fop/imageView_n_100x200.jpg}
\end{center}
...
\begin{sample}
  \caption{按宽度缩小后裁剪正中部分生成250x200缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageView_1_250x200.jpg}
    \end{center}
...
\begin{sample}
  \caption{按宽度或高度缩小后裁剪正中部分生成200x200缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageView_1_200x200.jpg}
    \end{center}
...
\begin{sample}
  \caption{按高度缩小后裁剪正中部分生成200x300缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageView_1_200x300.jpg}
    \end{center}
...
\begin{sample}
  \caption{按高度放大后裁剪正中部分生成200x500缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageView_1_200x500.jpg}
    \end{center}
...
\begin{sample}
  \caption{宽度固定为200px，高度等比缩小，生成200x133缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageView_2_200x200.jpg}
    \end{center}
...
\begin{sample}
  \caption{高度固定为200px，宽度等比缩小，生成300x200缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageView_2_x200.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成480x320缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_75p.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成700x467放大图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_700px.jpg}
    \end{center}
...
\begin{sample}
  \caption{限定长边，生成不超过300x300的缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_300x300.jpg}
    \end{center}
...
\begin{sample}
  \caption{限定短边，生成不小于200x200的缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_200x200r.jpg}
    \end{center}
...
\begin{sample}
  \caption{强制生成200x300的缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_200x300_force.jpg}
    \end{center}
...
\begin{sample}
  \caption{原图大于指定长宽矩形，按长边自动缩小为200x133缩略图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_200x300_greater.jpg}
    \end{center}
...
\begin{sample}
  \caption{原图小于指定长宽矩形，按长边自动拉伸为700x467放大图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_700x600_less.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成图的像素总数小于指定值}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_350000_at.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成300x427裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_300x.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成640x200裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_x200.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_300x300.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成300x300裁剪图，偏移距离30x100}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_300x300_a30a100.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成300x200裁剪图，偏移距离30x0}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_300x300_a30s100.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成270x300裁剪图，偏移距离0x100}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_300x300_s30a100.jpg}
    \end{center}
...
\begin{sample}
  \caption{生成270x200裁剪图，偏移距离0x0}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_300x300_s30s100.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在左上角（NorthWest），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_northwest.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在正上方（North），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_north.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在右上角（NorthEast），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_northeast.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在正左方（West），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_west.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在正中（Center），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_center.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在正右方（East），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_east.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在左下角（SouthWest），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_southwest.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在正下方（South），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_south.jpg}
    \end{center}
...
\begin{sample}
  \caption{锚点在右下角（SouthEast），生成300x300裁剪图}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_southeast.jpg}
    \end{center}
...
\begin{sample}
  \caption{顺时针旋转45度}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_rotate_45.jpg}
    \end{center}
...
\begin{sample}
  \caption{缩小后裁剪}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_thumbnail_crop.jpg}
    \end{center}
...
\begin{sample}
  \caption{裁剪后放大}
    ...
    \begin{center}
      \includegraphics[scale=1.1]{../pics/pic_fop/imageMogr_crop_thumbnail.jpg}
    \end{center}
