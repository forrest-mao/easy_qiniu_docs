...
\begin{sample}
  \caption{锚点在右上角（NorthEast），生成300x300缩略图}
    \qpar{\qurl{http://qiniuphotos.qiniudn.com/gogopher.jpg}}
    \qpar{$\Rightarrow$}
    \qpar{\qurl{http://qiniuphotos.qiniudn.com/gogopher.jpg?imageMogr/v2/gravity/NorthEest/crop/300x300}}
...
\begin{sample}
  \caption{锚点在右下角（SouthEast），生成300x300缩略图}
    \qpar{\qurl{http://qiniuphotos.qiniudn.com/gogopher.jpg}}
    \qpar{$\Rightarrow$}
    \qpar{\qurl{http://qiniuphotos.qiniudn.com/gogopher.jpg?imageMogr/v2/gravity/SouthEest/crop/300x300}}
